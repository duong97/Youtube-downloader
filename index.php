...
<head>
  ...
  <style>
    ...
    .downloadtxt{text-align: center;}
    .dlarea{padding-top: 15px; color: white;
      display: <?php if (isset($links)) echo "block"; else echo "none"; ?>
    }
  </style>
  <script>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 well text-left middle"> 
...
<br><br>
<div class="dlarea" style="background: #0e465d">
  <h4 class="downloadtxt">DOWNLOAD AUDIO</h4>
 <iframe class="button-api-frame" src="https://youtubemp3api.com/@api/button/mp3/<?php echo $links['id'] ?>" width="100%"  allowtransparency="true" scrolling="no" style="border:none"></iframe>
</div>
 
<div class="dlarea" style="background: #425642">
  <h4 class="downloadtxt">DOWNLOAD VIDEO</h4>
 <iframe class="button-api-frame" src="https://youtubemp3api.com/@api/button/videos/<?php echo $links['id'] ?>" width="100%"  allowtransparency="true" scrolling="no" style="border:none"></iframe>
</div>
